    ...
    <aside id="sidebar"
        ...
        <div
            ...
            <div class="p-6 border-t border-white/50">
                <div class="flex items-center gap-3 px-4 py-4 bg-white/40 rounded-2xl border border-white/60">
                    <div
                        class="w-10 h-10 rounded-full bg-gradient-to-tr from-green-100 to-green-50 border border-green-200 flex items-center justify-center">
                        <span class="text-green-700 font-bold text-sm">JC</span>
                    </div>
                    <div class="flex-grow min-w-0">
                        <p class="text-xs font-bold text-gray-800 truncate">Jithosh Chandran</p>
                        <p class="text-[9px] font-bold text-gray-400 uppercase truncate">Administrator</p>
                    </div>
                </div>
            </div>
        </div>
