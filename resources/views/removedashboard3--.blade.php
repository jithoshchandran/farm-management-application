...
<head>
    ...
    <title>Dashboard 3 - Premium Cow Management</title>
...
<body class="p-6 md:p-12">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <!-- Total Cows -->
            <a href="/admin/cows?filters[animal_classification][value]=Cow"
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                ...
                <div class="flex gap-4">
                    ...
                    <div
                        ...
                        <p class="text-[10px] font-bold text-{{ $trend >= 0 ? 'green' : 'red' }}-400 uppercase">Trend
                        </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            @if ($pregnantCows->count() > 0)
                                ...
                                <div class="cow-sub-card p-5 flex gap-6 bg-white/40">
                                    ...
                                    <div class="flex-grow flex flex-col justify-between">
                                        <div>
                                            <h5 class="text-2xl font-bold text-gray-800">{{ $featured->name ?: $featured->tag_number }}
                                            </h5>
                        ...
                        <div class="glass-card p-6 border-none shadow-xl">
                            ...
                            <div class="cow-sub-card p-5 bg-white/40 min-h-[148px]">
                                <p class="text-xs font-bold text-gray-400 mb-4 uppercase tracking-wider">Upcoming Tasks
                                </p>
                                <div class="space-y-3">
                            ...
                            <div class="cow-sub-card p-5 flex gap-5 bg-white/40">
                                ...
                                <div class="w-2/3 flex flex-col justify-between">
                                    ...
                                    <div class="mt-2 space-y-0.5 text-xs font-semibold text-gray-500">
                                        ...
                                        <p>DOB: <span
                                                class="text-gray-800">{{ $calf->dob->format('d M Y') }}</span></p>
